...
use rustic_ray::{Camera, patterns::Checkers, Color, Point, PointLight, Transform, Vector, World, patterns::Stripe, ray_tracing::camera::AntiAlias, ray_tracing::color, shapes::Cube};

fn main() {
    let mut world = World::new();

    let mut checkers = Checkers::new(color::WHITE, color::BLACK);
    checkers.transform = Transform::new()
        .scaling(0.15, 0.15, 0.15)
        .build();

    let mut stripes1 = Stripe::new(
        Color::new_rgb(161, 64, 5),
        Color::new_rgb(145, 41, 3));
    stripes1.transform = Transform::new()
            .scaling(0.05, 0.05, 0.05)
            .rotation_y(PI / 2.0)
            .build();

    let mut stripes2 = Stripe::new(
        Color::new_rgb(161, 64, 5),
        Color::new_rgb(145, 41, 3));
    stripes2.transform = Transform::new()
            .scaling(0.05, 0.05, 0.05)
            .build();
    ...
    world.objects.push(Box::new(painting));
    ...
    world.objects.push(Box::new(painting2));
    ...
    world.objects.push(Box::new(painting3));
    ...
    world.objects.push(Box::new(mirror));
    ...
    world.objects.push(Box::new(table_top));
    ...
    world.objects.push(Box::new(leg1));
    ...
    world.objects.push(Box::new(leg2));
    ...
    world.objects.push(Box::new(leg3));
    ...
    world.objects.push(Box::new(leg4));
    ...
    world.objects.push(Box::new(block1));
    ...
    world.objects.push(Box::new(block3));
    ...
    c.render_to_file(world, AntiAlias::EightByEight, 5, "room.png");
}
